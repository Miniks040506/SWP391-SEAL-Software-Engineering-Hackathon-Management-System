...
public class TeamController {
    ...
    @Operation(
            ...
            description = "Remove Member through DELETE /api/v1/teams/{teamId}/members/{memberId}. Successful execution returns HTTP 204 without a response body. Access: Authenticated via SecurityConfig matcher /api/v1/teams/**; @PreAuthorize(\"isAuthenticated()\"). Optionally accepts a ReasonRequest request body.",
            operationId = "teamRemoveMember",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "Remove member completed successfully with no response body."),
            @ApiResponse(
                    responseCode = "400",
                    description = "Request syntax, parameter conversion, or validation failed.",
                    content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))
    ...
    public ResponseEntity<Void> removeMember(
            @Parameter(description = "Unique team identifier.", required = true)
            @PathVariable UUID teamId,
            @Parameter(description = "Member Id value.", required = true)
    ...
    @Operation(
            ...
            description = "Accept Invitation through POST /api/v1/teams/invitations/{invitationId}/accept. Successful execution returns HTTP 200 with TeamMemberResponse. Access: Authenticated via SecurityConfig matcher /api/v1/teams/**; @PreAuthorize(\"isAuthenticated()\").",
            operationId = "teamAcceptInvitation",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses({
            @ApiResponse(
    ...
    @Operation(
            ...
            description = "Reject Invitation through POST /api/v1/teams/invitations/{invitationId}/reject. Successful execution returns HTTP 204 without a response body. Access: Authenticated via SecurityConfig matcher /api/v1/teams/**; @PreAuthorize(\"isAuthenticated()\"). Optionally accepts a ReasonRequest request body validated with Jakarta Bean Validation.",
            operationId = "teamRejectInvitation",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses({
    ...
    @PreAuthorize("isAuthenticated()")
    @Operation(
            summary = "Transfer Leader",
            description = "Transfer Leader through POST /api/v1/teams/{teamId}/transfer-leader. Successful execution returns HTTP 200 with TeamResponse. Access: Authenticated via SecurityConfig matcher /api/v1/teams/**; @PreAuthorize(\"isAuthenticated()\"). Requires a TransferLeaderRequest request body validated with Jakarta Bean Validation.",
            operationId = "teamTransferLeader",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "Transfer leader completed successfully.",
                    useReturnTypeSchema = true
            ),
            @ApiResponse(
                    responseCode = "400",
    ...
    @Operation(
            summary = "Leave Team",
            description = "Leave Team through POST /api/v1/teams/{teamId}/leave. Successful execution returns HTTP 204 without a response body. Access: Authenticated via SecurityConfig matcher /api/v1/teams/**; @PreAuthorize(\"isAuthenticated()\"). Optionally accepts a ReasonRequest request body validated with Jakarta Bean Validation.",
            operationId = "teamLeaveTeam",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "Leave team completed successfully with no response body."),
            @ApiResponse(
                    responseCode = "400",
                    description = "Request syntax, parameter conversion, or validation failed.",
                    content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))
    ...
    @PreAuthorize("isAuthenticated()")
    @Operation(
            summary = "Toggle Join Code",
            description = "Toggle Join Code through PATCH /api/v1/teams/{teamId}/join-code. Successful execution returns HTTP 200 with TeamResponse. Access: Authenticated via SecurityConfig matcher /api/v1/teams/**; @PreAuthorize(\"isAuthenticated()\"). Requires a ToggleJoinCodeRequest request body validated with Jakarta Bean Validation.",
            operationId = "teamToggleJoinCode",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "Toggle join code completed successfully.",
                    useReturnTypeSchema = true
            ),
            @ApiResponse(
                    responseCode = "400",
