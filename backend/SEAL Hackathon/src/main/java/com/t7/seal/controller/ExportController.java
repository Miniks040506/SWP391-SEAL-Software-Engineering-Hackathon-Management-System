...
public class ExportController {
    ...
    @Operation(
            ...
            description = "Download Export File through GET /api/v1/exports/{exportId}/download-file. Successful execution returns HTTP 200 with Resource. Access: SecurityConfig roles ADMIN, COORDINATOR via matcher /api/v1/exports/**; @PreAuthorize(\"hasAnyRole('ADMIN', 'COORDINATOR')\").",
            operationId = "exportDownloadExportFile",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses({
            @ApiResponse(
    ...
    @Operation(
            ...
            description = "Retry Export through POST /api/v1/exports/{exportId}/retry. Successful execution returns HTTP 200 with ExportJobResponse. Access: SecurityConfig roles ADMIN, COORDINATOR via matcher /api/v1/exports/**; @PreAuthorize(\"hasAnyRole('ADMIN', 'COORDINATOR')\").",
            operationId = "exportRetryExport",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "Retry export completed successfully.",
                    useReturnTypeSchema = true
            ),
            @ApiResponse(
                    responseCode = "400",
