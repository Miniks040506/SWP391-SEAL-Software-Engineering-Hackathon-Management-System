...
public class AiSafetyLogServiceImpl implements AiSafetyLogService {
    @Override
    public void record(User user, AiConversation conversation, AiGuardrailResult result, String message, String pageContext) {

    }

    @Override
    public Page<AiSafetyLogResponse> listSafetyLogs(String decision, Pageable pageable) {
        return null;
    }
}
