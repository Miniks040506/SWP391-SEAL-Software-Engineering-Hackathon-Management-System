...
--   G. Beta Builders DRAFT submission in the OPEN final round
...
INSERT INTO round_judge_assignments (id, round_id, judge_id, track_id, scoring_progress, total_to_score, assigned_by, assigned_at, reminded_at) VALUES
                                                                                                                                                    ('18000000-0000-4000-8000-000000000321', 'd7104abc-8192-5a20-bcd8-4b99748297bb', '79f650d1-4a5b-552a-8f9b-98570a7a2021', '8039cc28-1b76-556f-8bc2-2e544416d4c8', 0, 1, '0406b2de-5dcd-59c7-ad4c-e614f1f201a5', NOW() - INTERVAL '1 day', NULL),
...
-- ---------------------------------------------------------------------
-- G. Beta Builders DRAFT submission in the OPEN Final Demo Round.
...
INSERT INTO submissions (id, team_id, round_id, note, submitted_at, updated_at, status, submission_number) VALUES
    ('18000000-0000-4000-8000-000000000401', '116fd0f3-5388-5a49-8439-3464b4bc8d3d', 'd7104abc-8192-5a20-bcd8-4b99748297bb', 'Beta Builders final-round DRAFT (edit/submit-me).', NOW() - INTERVAL '6 hours', NOW() - INTERVAL '6 hours', 'DRAFT', 1);
...
INSERT INTO submission_links (id, submission_id, link_type, url, label, storage_provider, object_key, original_file_name, content_type, file_size_bytes, repo_metadata, is_primary, display_order, created_at, updated_at) VALUES
                                                                                                                                                                                                                               ('18000000-0000-4000-8000-000000000411', '18000000-0000-4000-8000-000000000401', 'REPOSITORY', 'https://github.com/seal-demo/beta-builders-final', 'Final Repository (draft)', 'GITHUB', NULL, NULL, NULL, NULL, NULL, TRUE, 1, NOW() - INTERVAL '6 hours', NOW() - INTERVAL '6 hours'),
                                                                                                                                                                                                                               ('18000000-0000-4000-8000-000000000412', '18000000-0000-4000-8000-000000000401', 'DEMO',       'https://beta-final.demo.seal.test',                'Final Demo (draft)',       'EXTERNAL_URL', NULL, NULL, NULL, NULL, NULL, TRUE, 2, NOW() - INTERVAL '6 hours', NOW() - INTERVAL '6 hours');
