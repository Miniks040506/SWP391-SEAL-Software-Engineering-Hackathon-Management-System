...
export const CoordinatorCreateEventPage = () => {
  ...
  const validateStepOne = () => {
    ...
    if (
      formValues.competitionStartDate &&
      formValues.registrationClose &&
      formValues.competitionStartDate >= formValues.registrationClose
    ) {
      nextErrors.registrationClose = "Registration close date must be before competition start date";
      nextErrors.competitionStartDate = "Competition start date must be after registration close date";
    }
