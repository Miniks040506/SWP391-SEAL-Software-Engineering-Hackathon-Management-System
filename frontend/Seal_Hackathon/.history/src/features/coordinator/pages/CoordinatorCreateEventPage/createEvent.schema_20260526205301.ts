...
export const eventSeasons = ["Spring", "Summer", "Fall"] as const;
...
export const roundSchema = z
  .object({
    ...
    advancementRuleType: z.enum(advancementRuleTypes),
...
export const eventDetailsSchema = z
  .object({
    ...
    season: z.enum(eventSeasons, { message: "Invalid season" }),
...
export type EventSeason = (typeof eventSeasons)[number];
export type AdvancementRuleType = (typeof advancementRuleTypes)[number];
