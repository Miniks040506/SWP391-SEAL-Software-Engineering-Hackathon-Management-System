            ...
            return (
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                  ...
                  <Controller
                    name={
                      `tracks.${trackIndex}.rounds.${roundIndex}.advancementRuleType` as const
                    }
                    control={control}
                    render={({ field }) => (
                      <TextField
                  ...
                  <TextField
                    label="Value"
                    placeholder="e.g. 10 (for Top-N Teams) or 80% (for Threshold Score)"
      ...
      <div className="flex items-center justify-between border-b border-gray-100 px-7 py-5">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Add competition tracks first, then configure rounds for each track.
          </p>
        ...
        <Button
          ...
          variant="outlined"
          startIcon={<AddOutlinedIcon />}
          onClick={() => appendTrack(createEmptyTrack())}
          sx={{
            bgcolor: "#2563eb",
            fontWeight: 800,
            "&:hover": {
      ...
      <div className="space-y-6 px-7 py-6">
        ...
        {trackFields.map((trackField, trackIndex) => (
          <TrackCard
            ...
            trackFieldId={trackField.fieldId}
            onDeleteTrack={() => removeTrack(trackIndex)}
          />
        ))}
      </div>
