  ...
  return (
    ...
    >
      <div className="bg-[#2b2d31] text-white">
        ...
        <div className="px-6">
          <div className="relative h-90 overflow-hidden rounded-xl bg-[#1e1f22]">
            <Cropper
              image={imageUrl}
              crop={crop}
              zoom={zoom}
          ...
          <div className="mt-5 rounded-xl bg-[#383a40] px-4 py-3 text-sm font-bold leading-6 text-white">
            Kéo ảnh để chỉnh vị trí. Dùng thanh trượt để phóng to/thu nhỏ.
          </div>
        </div>
        ...
        <div className="mt-6 flex items-center justify-between px-6 pb-6">
          <button
            ...
            disabled={isApplying}
            className="text-sm font-bold text-indigo-300 transition-colors hover:text-indigo-200 hover:underline disabled:opacity-60"
          >
            Đặt lại
          </button>
