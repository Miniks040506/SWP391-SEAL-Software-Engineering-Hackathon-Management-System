...
export const mentorDashboardMock: MentorDashboardData = {
  ...
  summaryCards: [
    ...
    },
    {
      ...
      value: 2,
      description: "Important deadlines ahead",
      iconType: "deadline",
  ...
  upcomingSchedule: [
    {
      id: "schedule-1",
      date: "May 27, 2026",
      title: "Preliminary Submission Deadline",
      context: "SEAL Spring 2026 - AI Track",
    },
    {
      id: "schedule-2",
      date: "May 28, 2026",
      title: "Mentor Feedback Deadline",
      context: "SEAL Spring 2026 - AI Track",
    },
  ],
};