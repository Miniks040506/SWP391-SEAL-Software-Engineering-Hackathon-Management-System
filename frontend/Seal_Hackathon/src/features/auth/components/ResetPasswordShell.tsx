...
const STEPS = [
  {
    number: 1,
    label: "Email",
    description: "Tell us the address on your account.",
    icon: <MailOutlinedIcon sx={{ fontSize: 20 }} />,
  },
  {
    number: 2,
    label: "Verification",
  ...
  },
  {
    ...
    icon: <LockResetOutlinedIcon sx={{ fontSize: 20 }} />,
  },
  {
    number: 4,
    label: "Success",
...
export function ResetPasswordShell({ currentStep, children }: Props) {
  ...
  return (
    <div className="relative min-h-dvh bg-white font-sans text-slate-900 lg:grid lg:grid-cols-[52%_48%] dark:bg-[#020617] dark:text-slate-100">
      ...
      <aside className="sticky top-0 hidden h-dvh overflow-hidden lg:block">
        ...
        <div className="relative flex h-full flex-col justify-between gap-6 px-14 py-8 pr-28 text-white xl:px-16 xl:py-10">
          ...
          <div className="max-w-110">
            ...
            <h1 className="mt-5 text-3xl font-extrabold leading-[1.15] tracking-tight xl:text-4xl">
              Get back in
              <br />
            ...
            <p className="mt-3 max-w-95 text-base leading-7 text-blue-100/90 [@media(max-height:720px)]:hidden">
              Reset your password in a few quick steps and pick up right where
              your team left off.
            </p>
                ...
                return (
                  <li key={step.label} className="flex gap-4">
                    ...
                    <div className={index < STEPS.length - 1 ? "pb-5" : ""}>
                      ...
                      <p className="mt-0.5 text-sm leading-6 text-blue-100/70 [@media(max-height:780px)]:hidden">
                        {step.description}
                      </p>
                    </div>
                  </li>
      ...
      <div className="flex min-h-dvh flex-col px-6 py-6 sm:px-12 lg:px-14 xl:px-20">
        ...
        <div className="flex flex-1 flex-col">
          <div className="mx-auto my-auto w-full max-w-120 py-8">{children}</div>
        </div>
