export const podiumStyles = {
  wrapper: 'grid grid-cols-1 md:grid-cols-3 gap-6 items-end max-w-4xl mx-auto',
  ...
  firstDot:  'w-20 h-20 bg-blue-50  rounded-full flex items-center justify-center text-blue-500  font-bold text-3xl border-4 border-blue-100',
  secondDot: 'w-14 h-14 bg-slate-100 rounded-full flex items-center justify-center text-slate-500 font-bold text-xl  border-4 border-slate-50',
  thirdDot:  'w-14 h-14 bg-amber-50  rounded-full flex items-center justify-center text-amber-600 font-bold text-xl  border-4 border-amber-50',
} as const;
...
export const filterStyles = {
  ...
  searchInput: 'pl-9 pr-4 py-2 bg-gray-50 border-none rounded-lg text-sm font-semibold text-gray-700 focus:ring-1 focus:ring-blue-400 w-56 shadow-inner',
  select:      'px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-bold text-gray-600 focus:outline-none shadow-sm min-w-35',
} as const;
...
/** Shared MUI Pagination sx overrides. */
