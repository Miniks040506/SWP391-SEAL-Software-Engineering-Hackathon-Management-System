...
export const LeaderboardPage = () => {
  ...
  const filteredRankings: RankingEntry[] = useMemo(() => RANKINGS.filter(
        r => (filterTrack === 'All' || r.track === filterTrack) && r.team.toLowerCase().includes(searchTerm.toLowerCase()),
      ),
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-gray-50">
              {filteredRankings.length > 0 ? (
                ...
                <tr>
                  <td colSpan={4} className="p-24 text-center text-sm text-gray-400 font-bold uppercase tracking-widest">
                    No results found
                  </td>
                </tr>
              )}
        ...
        <div className="p-6 bg-blue-50/50 border border-blue-100 rounded-2xl flex items-start gap-4 shadow-sm">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-500 font-semibold leading-relaxed">
              All results displayed are official. Scores have been verified through Inter-Rater
              Reliability (IRR) analysis to ensure absolute fairness across all judging panels.
            </p>
          </div>
        </div>
      </div>
