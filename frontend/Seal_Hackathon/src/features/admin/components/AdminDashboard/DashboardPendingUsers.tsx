...
import type { PendingRequest } from "@/features/admin/hooks/useAdminDashboardMutation";
          ...
          {pendingRequests.length === 0 ? (
            ...
            pendingRequests.map((item, index) => (
              ...
              >
                ...
                <span
                  className={`px-2.5 py-1 rounded-[4px] text-[10px] font-extrabold uppercase tracking-widest shrink-0 ${getPendingBadgeStyle(item.type)}`}
                >
                  {item.type.replace("_", " ")}
                </span>
              </div>
