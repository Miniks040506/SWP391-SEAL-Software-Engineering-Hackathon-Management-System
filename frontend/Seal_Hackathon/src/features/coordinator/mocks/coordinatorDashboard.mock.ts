...
export const mockCoordinatorDashboard = {
  summaryCards: [
    ...
    { title: "Registered Teams", value: 18, description: "Teams registered for this event", iconType: "team", color: "bg-orange-50 text-orange-600" },
  ...
  pendingActions: [
    { id: "pa-1", title: "18 teams still forming — not yet registered", description: "These teams haven't completed registration. Remind participants to register their team.", actionLabel: "View Teams", path: "/coordinator/teams", priority: "High" },
  ...
  recentActivities: [
    { id: "ac-1", time: "May 22, 2026 - 10:30", title: "Team registered", description: "Team Code Warriors successfully registered for AI Track." },
    { id: "ac-2", time: "May 22, 2026 - 09:15", title: "Judge assigned", description: "You assigned Nguyen Van D to AI Track - Preliminary Round." },
    { id: "ac-3", time: "May 21, 2026 - 16:45", title: "Notification sent", description: "Submission deadline reminder was sent to all registered teams." },
