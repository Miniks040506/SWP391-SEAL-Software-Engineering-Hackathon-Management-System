...
export function CoordinatorEditEventPage() {
  ...
  return (
    <div className="space-y-7 animate-in fade-in duration-500">
      ...
      {activeTab === "ROUNDS" && <RoundsTab eventId={eventId} event={eventQuery.data!} tracks={tracksQuery.data ?? []} rounds={roundsQuery.data ?? []} isLoading={roundsQuery.isLoading} onChanged={invalidateEditData} canEdit={editRules.canEditTracksRounds} readonlyReason={editRules.trackRoundReason} />}
